...
import net.runelite.client.plugins.testing.balaclavaapi.utility.Walk;
import net.runelite.client.plugins.testing.ethanapi.collections.Inventory;
import net.runelite.client.plugins.testing.ethanapi.collections.TileObjects;
...
import static net.runelite.client.plugins.testing.ethanapi.collections.query.TileObjectQuery.getObjectComposition;
import static net.runelite.client.plugins.testing.ethanapi.EthanApi.sendClientMessage;
import static net.runelite.client.plugins.testing.ethanapi.EthanApi.stopPlugin;

@PluginDescriptor(
        name = ".L~AutoTitheFarm",
